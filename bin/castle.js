	...
	,bindEvent: function(n,id,name,eid) {
		...
		var callb = function(e) {
			...
			if(sendValue) {
				...
				_gthis.send(cdb_jq_Answer.SetValue(id,callb1));
			}
...
Level.prototype = {
	...
	,init: function() {
		...
		while(_g2 < _g11.length) {
			...
			case 0:
				...
				break;
			case 8:
				var name1 = this.sheet.name + "@" + c.name;
				var _this = SheetData.model.smap;
				var sheet = (__map_reserved[name1] != null ? _this.getReserved(name1) : _this.h[name1]).s;
				var floatCoord = false;
				var tmp;
				if(!(SheetData.hasColumn(sheet,"x",[cdb_ColumnType.TInt]) && SheetData.hasColumn(sheet,"y",[cdb_ColumnType.TInt]))) {
					floatCoord = SheetData.hasColumn(sheet,"x",[cdb_ColumnType.TFloat]) && SheetData.hasColumn(sheet,"y",[cdb_ColumnType.TFloat]);
					tmp = floatCoord;
				} else {
					tmp = true;
				}
	...
	,addNewLayer: function(name) {
		...
		if(_g[1] == 8) {
			var name1 = this.sheet.name + "@" + this.newLayer.name;
			var _this = SheetData.model.smap;
			var s = (__map_reserved[name1] != null ? _this.getReserved(name1) : _this.h[name1]).s;
...
Model.prototype = {
	...
	,deleteSheet: function(sheet) {
		...
		while(_g < _g1.length) {
			...
			switch(_g2[1]) {
			case 8:case 17:
				var name = sheet.name + "@" + c.name;
				var _this = SheetData.model.smap;
				this.deleteSheet((__map_reserved[name] != null ? _this.getReserved(name) : _this.h[name]).s);
				break;
			default:
			}
		}
	...
	,updateColumn: function(sheet,old,c) {
		...
		if(old.name != c.name) {
			...
			renameRec = function(sheet1,col) {
				var name = sheet1.name + "@" + col.name;
				var _this = SheetData.model.smap;
				var s = (__map_reserved[name] != null ? _this.getReserved(name) : _this.h[name]).s;
	...
	,parseVal: function(t,val) {
		...
		case 6:
			var t1 = t[2];
			var _this = this.smap;
			var _this1 = (__map_reserved[t1] != null ? _this.getReserved(t1) : _this.h[t1]).index;
			var r = __map_reserved[val] != null ? _this1.getReserved(val) : _this1.h[val];
			if(r == null) {
		...
		case 9:
			...
			return this.parseTypeVal(__map_reserved[t2] != null ? _this2.getReserved(t2) : _this2.h[t2],val);
		case 11:
			if(val.charAt(0) == "#") {
		...
		convertTypeRec = function(t,o) {
			...
			while(_g1 < _g) {
				...
				case 9:
					...
					var convertTypeRec1 = __map_reserved[name] != null ? _this.getReserved(name) : _this.h[name];
			...
			while(_g21 < _g31.length) {
				...
				case 9:
					...
					while(_g42 < _g51.length) {
						...
						convertTypeRec2(__map_reserved[t1] != null ? _this1.getReserved(t1) : _this1.h[t1],o1);
					}
					break;
				default:
				}
		...
		convertTypeRec = function(t1,v3) {
			...
			while(_g13 < _g4) {
				...
				if(_g21[1] == 9) {
					...
					if(av != null) {
						var _this = _gthis.tmap;
						var convertTypeRec1 = __map_reserved[tname] != null ? _this.getReserved(tname) : _this.h[tname];
...
Main.prototype = $extend(Model.prototype,{
	...
	,tileHtml: function(v,isInline) {
		...
		var html = "<div class=\"tile\" id=\"_c" + id + "\" style=\"width : " + (width * zoom | 0) + "px; height : " + (height * zoom | 0) + "px; background : url('" + path + "') -" + (v.size * v.x * zoom | 0) + "px -" + (v.size * v.y * zoom | 0) + "px; " + inl + "\"></div>";
	...
	,valueHtml: function(c,v,sheet,obj) {
		...
		case 0:
			if(v == "") {
				...
				var key = sheet.name;
				var _this = this.smap;
				var _this1 = (__map_reserved[key] != null ? _this.getReserved(key) : _this.h[key]).index;
				var key1 = v;
				if((__map_reserved[key1] != null ? _this1.getReserved(key1) : _this1.h[key1]).obj == obj) {
					return v;
				} else {
		...
		case 6:
			...
			if(v == "") {
				...
				var _this2 = this.smap;
				var s = __map_reserved[sname] != null ? _this2.getReserved(sname) : _this2.h[sname];
				var _this3 = s.index;
				var key2 = v;
				var i = __map_reserved[key2] != null ? _this3.getReserved(key2) : _this3.h[key2];
				if(i == null) {
		...
		case 8:
			...
			var ps = (__map_reserved[name] != null ? _this4.getReserved(name) : _this4.h[name]).s;
			var out = [];
			var size = 0;
			var _g2 = 0;
			while(_g2 < a.length) {
		...
		case 9:
			...
			var t = __map_reserved[name1] != null ? _this5.getReserved(name1) : _this5.h[name1];
			var a1 = v;
		...
		case 16:
			...
			return str1;
		case 17:
			var name2 = sheet.name + "@" + c.name;
			var _this6 = SheetData.model.smap;
			var ps1 = (__map_reserved[name2] != null ? _this6.getReserved(name2) : _this6.h[name2]).s;
			var out2 = [];
			var _g6 = 0;
	...
	,editCell: function(c,v,sheet,index) {
		...
		case 0:case 1:case 3:case 4:case 9:case 16:
			v.empty();
			var i = $(c.type == cdb_ColumnType.TString ? "<textarea>" : "<input>");
			v.addClass("edit");
			i.appendTo(v);
			if(val != null) {
				var _g1 = c.type;
				...
				case 9:
					var t = _g1[2];
					var _this = this.tmap;
					var tmp1 = this.typeValToString(__map_reserved[t] != null ? _this.getReserved(t) : _this.h[t],val);
					i.val(tmp1);
					break;
				case 16:
			...
			i.blur(function(_) {
				...
				if(c.type == cdb_ColumnType.TId && old1 != null) {
					...
					var _this2 = (__map_reserved[key] != null ? _this1.getReserved(key) : _this1.h[key]).index;
					var key1 = val;
					prevObj = __map_reserved[key1] != null ? _this2.getReserved(key1) : _this2.h[key1];
				} else {
					prevObj = null;
				}
				var prevTarget = null;
				if(nv == "" && c.opt) {
					...
					switch(_g3[1]) {
					case 0:
						val2 = _gthis.r_ident.match(nv) ? nv : null;
						break;
					case 3:
					...
					case 9:
						...
						try {
							...
							var val21 = __map_reserved[t1] != null ? _this3.getReserved(t1) : _this3.h[t1];
					...
					if(val2 != val && val2 != null) {
						...
						var _this5 = (__map_reserved[key2] != null ? _this4.getReserved(key2) : _this4.h[key2]).index;
						var key3 = val2;
						prevTarget = __map_reserved[key3] != null ? _this5.getReserved(key3) : _this5.h[key3];
						if(c.type == cdb_ColumnType.TId && val != null && (prevObj == null || prevObj.obj == obj)) {
							var m = new haxe_ds_StringMap();
							var key4 = val;
							var value = val2;
							if(__map_reserved[key4] != null) {
								m.setReserved(key4,value);
							} else {
								m.h[key4] = value;
							}
				...
				if(c.type == cdb_ColumnType.TId && prevObj != null && old1 != val) {
					...
					if(prevObj.obj == obj) {
						...
						var _this7 = (__map_reserved[key5] != null ? _this6.getReserved(key5) : _this6.h[key5]).index;
						tmp4 = (__map_reserved[old1] != null ? _this7.getReserved(old1) : _this7.h[old1]) != null;
					} else {
						tmp4 = false;
					}
					if(!tmp4) {
						if(prevTarget != null) {
							var key6 = sheet.name;
							var _this8 = _gthis.smap;
							var _this9 = (__map_reserved[key6] != null ? _this8.getReserved(key6) : _this8.h[key6]).index;
							var key7 = val;
							tmp3 = (__map_reserved[key7] != null ? _this9.getReserved(key7) : _this9.h[key7]).obj != prevTarget.obj;
						} else {
							tmp3 = false;
						}
					} else {
			...
			if(_g4[1] == 9) {
				var t2 = _g4[2];
				var _this10 = this.tmap;
				var t3 = __map_reserved[t2] != null ? _this10.getReserved(t2) : _this10.h[t2];
				i.keyup(function(_1) {
					var str = i.val();
					try {
						if(str != "") {
		...
		case 6:
			var sname = _g[2];
			var _this11 = this.smap;
			var sdat = __map_reserved[sname] != null ? _this11.getReserved(sname) : _this11.h[sname];
			if(sdat == null) {
				return;
			}
			v.empty();
		...
		while(_g31 < _g22) {
			...
			while(_g5 < _g4) {
				...
				case 7:
					...
					break;
				case 8:
					var key = [SheetData.getPath(sheet) + "@" + c[0].name + ":" + index1[0]];
					var tmp3 = (function(key1,html2,l2,v3,val3,obj3,index5,c7,cindex2) {
						return function(e7) {
							...
							var name = sheet.name + "@" + c7[0].name;
							var _this = SheetData.model.smap;
							var psheet = (__map_reserved[name] != null ? _this.getReserved(name) : _this.h[name]).s;
							if(val3[0] == null) {
								val3[0] = [];
								obj3[0][c7[0].name] = val3[0];
							}
							psheet = { columns : psheet.columns, props : psheet.props, name : psheet.name, path : key1[0], parent : { sheet : sheet, column : cindex2[0], line : index5[0]}, lines : val3[0], separators : []};
				...
				case 14:
					...
					break;
				case 17:
					var key3 = [SheetData.getPath(sheet) + "@" + c[0].name + ":" + index1[0]];
					var tmp23 = (function(key4,html4,l3,v11,val6,obj7,index7,c12,cindex3) {
						return function(e14) {
							...
							var name1 = sheet.name + "@" + c12[0].name;
							var _this3 = SheetData.model.smap;
							var psheet1 = (__map_reserved[name1] != null ? _this3.getReserved(name1) : _this3.h[name1]).s;
							if(val6[0] == null) {
								val6[0] = { };
								obj7[0][c12[0].name] = val6[0];
							}
							psheet1 = { columns : psheet1.columns, props : psheet1.props, name : psheet1.name, path : key4[0], parent : { sheet : sheet, column : cindex3[0], line : index7[0]}, lines : [val6[0]], separators : []};
							...
							if(__map_reserved[key4[0]] != null) {
								_this4.setReserved(key4[0],true);
							} else {
								_this4.h[key4[0]] = true;
							}
					...
					if(__map_reserved[key3[0]] != null ? _this5.getReserved(key3[0]) : _this5.h[key3[0]]) {
	...
	,initLevel: function(s) {
		...
		while(_g < cols.length) {
			...
			if(SheetData.hasColumn(s,c.n)) {
				...
				if(c.n == "layers") {
					var name = s.name + "@" + col.name;
					var _this = SheetData.model.smap;
					var s1 = (__map_reserved[name] != null ? _this.getReserved(name) : _this.h[name]).s;
	...
	,cleanLayers: function() {
		...
		while(_g < _g1.length) {
			...
			while(_g2 < _g3.length) {
				...
				var _g4 = c.type;
				if(_g4[1] == 8) {
					var name = s.name + "@" + c.name;
					var _this = SheetData.model.smap;
					var sub = (__map_reserved[name] != null ? _this.getReserved(name) : _this.h[name]).s;
	...
	while(_g < _g1.length) {
		...
		if(c.name == cname) {
			...
			if(c.type == cdb_ColumnType.TList || c.type == cdb_ColumnType.TProperties) {
				var name = sheet.name + "@" + c.name;
				var _this = SheetData.model.smap;
				SheetData.model.deleteSheet((__map_reserved[name] != null ? _this.getReserved(name) : _this.h[name]).s);
			}
			return true;
		}
	}
...
SheetData.updateValue = function(sheet,c,index,old) {
	...
	case 3:
		if(sheet.props.level != null && (c.name == "width" || c.name == "height")) {
			...
			if(sheet.props.displayColumn == c.name) {
				...
				var s1 = __map_reserved[key] != null ? _this1.getReserved(key) : _this1.h[key];
				var _g7 = 0;
			...
			if(sheet.props.displayIcon == c.name) {
				...
				var key1 = sheet.name;
				var _this3 = SheetData.model.smap;
				var s2 = __map_reserved[key1] != null ? _this3.getReserved(key1) : _this3.h[key1];
				var _g8 = 0;
	...
	default:
		if(sheet.props.displayColumn == c.name) {
			...
			var s3 = __map_reserved[key2] != null ? _this5.getReserved(key2) : _this5.h[key2];
			var _g9 = 0;
		...
		if(sheet.props.displayIcon == c.name) {
			...
			var s4 = __map_reserved[key3] != null ? _this7.getReserved(key3) : _this7.h[key3];
			var _g10 = 0;
...
cdb_BinSerializer.prototype = {
	...
	,serializeData: function(d,v) {
		...
		case 11:
			...
			while(k2.hasNext()) {
				...
				this.serializeData(d4,__map_reserved[k3] != null ? m1.getReserved(k3) : m1.h[k3]);
			}
			this.out.b.push(255);
			break;
		case 12:
			...
			while(k4.hasNext()) {
				...
				this.serializeData(d5,m2.get(k5));
			}
			this.out.b.push(255);
			break;
		}
	...
	,unserializeData: function(d) {
		...
		case 10:
			...
			while(true) {
				var i1 = this.bytes.b[this.position++];
				if(i1 == 255) {
					break;
				}
				this.position--;
		...
		case 11:
			...
			while(true) {
				var i2 = this.bytes.b[this.position++];
				if(i2 == 255) {
					break;
				}
				this.position--;
	...
	init: function() {
		...
		while(_g < _g1.length) {
			...
			if(c.name == "tileProps" && (c.type == cdb_ColumnType.TList || c.type == cdb_ColumnType.TProperties)) {
				var name = this.level.sheet.name + "@" + c.name;
				var _this = SheetData.model.smap;
				this.perTileProps = (__map_reserved[name] != null ? _this.getReserved(name) : _this.h[name]).s.columns;
			}
		}
...
cdb_BinSerializer.__meta__ = { obj : { s_1522840838 : ["cy25:cdb._BinSerializer.Schemay4:namey14:cdb.jq.Messagey9:enumValueny3:tagny2:idi1522840838y4:kindwy29:cdb._BinSerializer.SchemaKindy5:SEnum:1aawy24:cdb._BinSerializer.SDatay4:DInt:0wR9y7:DString:0wR9y5:DNull:1wR9y6:DArray:1wR9y5:DAnon:1aoy1:nR1y1:dwR9R11:0goR15y5:valueR16wR9R11:0ghhawR9R10:0wR9R11:0hawR9R10:0wR9R11:0hawR9R10:0wR9R10:0hawR9R10:0wR9R10:0wR9R10:0hawR9R10:0wR9R11:0wR9R12:1wR9R10:0hawR9R10:0hawR9R10:0hawR9R10:0wR9R11:0wR9R10:0hawR9R10:0wR9R11:0wR9R12:1wR9R11:0hawR9R10:0wR9R11:0wR9R12:1wR9R11:0hawR9R10:0wR9R11:0hawR9R10:0wR9R11:0wR9R13:1wR9y8:DDynamic:0wR9R12:1wR9R10:0hawR9R10:0wR9R11:0wR9R12:1wR9y6:DFloat:0hawR9R10:0wR9R12:1wR9R13:1wR9R10:0hawR9R13:1wR9R10:0hawR9R13:1wR9y7:DSchema:1i1522840838hawR9R10:0wR9R18:0hhy4:hashi24552517g"], s_560507292 : ["cy25:cdb._BinSerializer.Schemay4:namey13:cdb.jq.Answery9:enumValueny3:tagny2:idi560507292y4:kindwy29:cdb._BinSerializer.SchemaKindy5:SEnum:1aawy24:cdb._BinSerializer.SDatay4:DInt:0wR9y5:DNull:1wR9y7:DSchema:1i1835035702hawR9R10:0wR9y7:DString:0hawR9R10:0hhy4:hashi842410256g"], s_1835035702 : ["cy25:cdb._BinSerializer.Schemay4:namey17:cdb.jq.EventPropsy9:enumValueny3:tagny2:idi1835035702y4:kindwy29:cdb._BinSerializer.SchemaKindy5:SAnon:1aoy1:ny7:ctrlKeyy1:dwy24:cdb._BinSerializer.SDatay5:DNull:1wR12y5:DBool:0goR9y7:keyCodeR11wR12R13:1wR12y4:DInt:0goR9y8:shiftKeyR11wR12R13:1wR12R14:0goR9y6:targetR11wR12R13:1wR12R16:0goR9y5:valueR11wR12R13:1wR12y8:DDynamic:0goR9y5:whichR11wR12R13:1wR12R16:0ghy4:hashi-1524625560g"]}};
