		...
		case 0:case 1:case 3:case 4:case 9:case 16:
			...
			if(val != null) {
				...
				case 9:
					var t = _g6[2];
					var _this1 = this.tmap;
					var tmp4 = this.typeValToString(__map_reserved[t] != null ? _this1.getReserved(t) : _this1.h[t],val);
					i6.val(tmp4);
					break;
				case 16:
			...
			i6.blur(function(_2) {
				...
				if(c.type == cdb_ColumnType.TId && old1 != null) {
					...
					var _this3 = (__map_reserved[key] != null ? _this2.getReserved(key) : _this2.h[key]).index;
					var key1 = val;
					prevObj = __map_reserved[key1] != null ? _this3.getReserved(key1) : _this3.h[key1];
				} else {
					prevObj = null;
				}
				var prevTarget = null;
				if(nv == "" && c.opt) {
					...
					case 9:
						var t1 = _g8[2];
						try {
							var _this4 = _gthis.tmap;
							var val21 = __map_reserved[t1] != null ? _this4.getReserved(t1) : _this4.h[t1];
					...
					if(val2 != val && val2 != null) {
						...
						var _this6 = (__map_reserved[key2] != null ? _this5.getReserved(key2) : _this5.h[key2]).index;
						var key3 = val2;
						prevTarget = __map_reserved[key3] != null ? _this6.getReserved(key3) : _this6.h[key3];
				...
				if(c.type == cdb_ColumnType.TId && prevObj != null && old1 != val) {
					...
					if(prevObj.obj == obj) {
						var key5 = sheet.name;
						var _this7 = _gthis.smap;
						var _this8 = (__map_reserved[key5] != null ? _this7.getReserved(key5) : _this7.h[key5]).index;
						tmp7 = (__map_reserved[old1] != null ? _this8.getReserved(old1) : _this8.h[old1]) != null;
					} else {
						tmp7 = false;
					}
					if(!tmp7) {
						if(prevTarget != null) {
							var key6 = sheet.name;
							var _this9 = _gthis.smap;
							var _this10 = (__map_reserved[key6] != null ? _this9.getReserved(key6) : _this9.h[key6]).index;
							var key7 = val;
							tmp6 = (__map_reserved[key7] != null ? _this10.getReserved(key7) : _this10.h[key7]).obj != prevTarget.obj;
						} else {
							tmp6 = false;
						}
					} else {
			...
			if(_g9[1] == 9) {
				var t2 = _g9[2];
				var _this11 = this.tmap;
				var t3 = __map_reserved[t2] != null ? _this11.getReserved(t2) : _this11.h[t2];
